...
from app.tools.ported.ac.workers.models import WorkerTask
from app.tools.ported.ac.workers.onec_com32_helper import com32_worker_timeout_seconds
...
class OneCSearchTasksTool(OneCReadOnlyTool):
    ...
    def __init__(self, worker: BaseWorker) -> None:
        """Создать инструмент."""
        super().__init__(_definition("onec.search_tasks", "Поиск задач исполнителя 1С (не ТД_Поручения)"), worker)
