...
from app.tools.ported.ac.workers.onec_errors import OneCConnectionError
from app.tools.ported.ac.workers.onec_meeting_notes import (
    MEETING_FIELDS,
    assert_select_only,
...
def execute_onec_com_readonly(task: WorkerTask) -> WorkerResult:
    ...
    used_com32 = False
    try:
        from app.tools.ported.ac.workers.com_availability import prefers_com32
...
def _com32_select(
    ...
    *,
    ...
    from app.tools.ported.ac.workers.onec_com32_helper import Com32TimeoutError, run_select_first
