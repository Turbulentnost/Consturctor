...
# Срочность поручений Документ.ТД_Поручения (пастельная палитра)
URGENCY_COLORS = {
    "overdue": "#FECACA",
    "due_soon": "#FFE0B2",
    "due_3days": "#FFF9C4",
...
def qss_global(family: str) -> str:
    ...
    * {{
    ...
    QLabel, QPushButton, QLineEdit, QPlainTextEdit, QListWidget, QToolTip {{
        font-family: "{family}";
    }}
    QWidget#MainWindow {{
        background: {COLOR_CONTENT_BG.name()};
    }}
    QToolTip {{
        background: #0a4a38;
        color: #f5f7f6;
