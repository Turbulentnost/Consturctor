...
как на описание обязанностей. Не делай плитки success_rate / runs_count / ошибки запусков агента.
...
- Не выдумывай поля 1С. В system пиши, какие инструменты смотреть: Outlook календарь, 1С задачи, файлы запусков.
