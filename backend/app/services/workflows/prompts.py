...
def build_playbook_draft_prompt(
    *,
    ...
    return (
        ...
        "Если в материалах явно не сказано, когда запускать агента "
        "(вручную / каждые N минут / ежедневно / при конкретном письме или файле) — "
        "обязательно спроси. Не выдумывай расписание из цели вроде «контролировать сроки» "
        "или «нарушение SLA». "
