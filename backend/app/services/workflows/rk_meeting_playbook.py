...
def rk_playbook_instructions() -> str:
    ...
    return (
        ...
        "2. 1С — только чтение (OData): не вызывай onec.odata_post, onec.odata_patch, "
        "onec.attach_file и не создавай/не меняй документы в 1С.\n"
        "   Поручения без фильтра по статусам ТЗ:\n"
