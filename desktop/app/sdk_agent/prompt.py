...
askQuestion: один пробел, один вопрос. Всегда передавай 2-6 конкретных вариантов в options. После ответа пользователя продолжай с этого ответа. Не начинай заново.
