    ...
    def __init__(self) -> None:
        super().__init__(
            ToolDefinition(
                ...
                title="Показать совещания в календаре",
                description=(
                    "Показывает совещания на вкладке Календарь у пользователя. "
                    "mark=cancel или red - красным, рекомендовано отменить. "
                    "mark=add или green - зеленым, рекомендовано поставить. "
                    "mark=keep - уже запланированное. "
                    "Вызови при формировании результата, чтобы человек увидел план на календаре. "
                    "В Outlook ничего не пишет."
                ),
