...
VALUES
    ...
    ('onec.com.status', '', '1C ERP COM service status', '[]'),
    ('onec.com.connect', '', 'Connect to 1C ERP via COMConnector', '[]'),
    ('onec.com.invoke', '', 'Invoke COM method on 1C ERP session', '[]'),
    ('onec.com.query_tasks', '', 'List performer tasks via 1C ERP COM query', '[]'),
    ('onec.com.release', '', 'Release 1C ERP COM session', '[]'),
    ...
    ('desktop.system_info', '', 'Desktop host system information', '[]'),
    ('desktop.capabilities', '', 'Desktop host tool capabilities', '[]'),
    ('desktop.clipboard_read', '', 'Read clipboard text', '[]'),
    ('desktop.clipboard_write', '', 'Write clipboard text', '[]'),
    ('desktop.open_path', '', 'Open path with default application', '[]'),
