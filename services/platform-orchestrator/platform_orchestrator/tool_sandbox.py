...
SANDBOX_TESTS: dict[str, MockScenario] = {
    ...
    "imap_omto": {
        ...
        "tool_calls": [
            ...
            {
                "thought": "Читаю сообщение 1/3 (uid из предыдущего search)",
                "tool_name": "imap.fetch_message",
                "payload": {"uid": "$uids.0", "user": "omto"},
            },
            {
                "thought": "Читаю сообщение 2/3 (uid из предыдущего search)",
                "tool_name": "imap.fetch_message",
                "payload": {"uid": "$uids.1", "user": "omto"},
            },
            {
                "thought": "Читаю сообщение 3/3 (uid из предыдущего search)",
                "tool_name": "imap.fetch_message",
                "payload": {"uid": "$uids.2", "user": "omto"},
            },
        ],
    },
    "browser_rostov_news": {
    ...
    "com_outlook_calendar": {
        ...
        "tool_calls": [
            ...
            },
            {
                ...
                "payload": {"session_id": "$session_id", "days": 7, "limit": 20},
            },
            {
                "thought": "Закрываю COM-сессию Outlook",
                "tool_name": "com.outlook.close",
                "payload": {"session_id": "$session_id", "quit": False},
            },
        ],
    },
}
